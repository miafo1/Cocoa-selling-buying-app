  ...
  <div class="container">
    <div class="row row-pb-md">
      <div class="col-md-4 fh5co-widget">
        <h3>Cacoa_corp</h3>
        <p style="color: darkgrey;">Rejoin Cacoa_corp pour des details profesionel</p>
            ...
            <ul class="fh5co-footer-links">
              <li>
                <a href="#"><span class="fa fa-map-marker fa-1x"></span>
                  <span class="text">  &nbsp; &nbsp; Topson | Ariel</span>
                </a>
              </li>
              <li>
                <a href="#"><span class="fa fa-phone fa-1x"></span>
                  <span class="text">&nbsp; &nbsp;+237 679775743</span>
                </a>
              </li>
              <li>
                <a href="#">
                  <span class="fa fa-envelope fa-1x"></span>
                  <span class="text">&nbsp; &nbsp;arielbrillandlepoui@gmail.com</span>
                </a>
              </li>
            </ul>
          </div>
    ...
    <div class="row copyright">
      <div class="col-md-12 text-center">
        <p>
          <small class="block" style="color: darkgrey;">EASY SELLING</small> 
          <small class="block" style="color: darkgrey;">LE DEVELOPEMENT AGRICOLE DU CAMER 237</small>
        </p>
      </div>
    </div>
  </div>
