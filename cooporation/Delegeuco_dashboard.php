...
<body style="background-color: #ededed;">
    ...
    <a href="manage_notifications.php">
        ...
        <span id="notification-count" class="badge" style="display:none;">0</span>
                ...
                <li><a href="view_members.php"><i class="fa fa-users-cog"></i> Manage Membre</a></li>
				<li><a href="add_stock.php"><i class="fa fa-users-cog"></i> Publier un stock</a></li>
			  			...
			  			<div class="container-fluid">
			  				...
			  				<div class="row">
			  					<div class="col-md-5 offset-md-7 text-right" style="color: #ccc;font-size: 16px; position: relative;">
			  						<p style="margin: 0px;margin-bottom: 0px; /*position: absolute*/;">Welcome <?php echo $_SESSION['name'].' '.$_SESSION['email']; ?> (Delegue)</p>
			  					</div>
			  				</div>
