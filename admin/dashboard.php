...
<body style="background-color: #ededed;">
    ...
    <a href="manage_notifications.php">
        <i class="fa fa-bell"></i> Manage Notifications 
        <span id="notification-count" class="badge" style="display:none;">0</span>
    </a>
</li>                <li><a href="manage_corporations.php"><i class="fa fa-building"></i> Manage Corporations</a></li>
                
                <li><a href="../user/viewregister.php"><i class="fa fa-users-cog"></i> Manage Membre</a></li>
                <li><a href="../region/regionview.php"><i class="fa fa-file-alt"></i> Region</a></li>
                <li><a href="../ville/townview.php"><i class="fa fa-file-alt"></i> vile/village</a></li>
			  			...
			  			<div class="container-fluid">
			  				...
			  				<div class="row">
			  					<div class="col-md-5 offset-md-7 text-right" style="color: #ccc;font-size: 16px; position: relative;">
			  						<p style="margin: 0px;margin-bottom: 0px; /*position: absolute*/;">Welcome <?php echo $_SESSION['name'].' '.$_SESSION['email']; ?> (Admin)</p>
			  					</div>
			  				</div>
							...
							<div id="footer-wrapper">
								<div class="row">
									...
									<div class="col-md-3" style="padding-left: 75px;">
										...
										<ul>
											<li class="contact-info"><i class="fa fa-map-marker"></i>ARIEL</li>
											<li class="contact-info"><i class="fa fa-phone"></i>+237 679-77-57-41</li>
											<li class="contact-info"><i class="fa fa-envelope"></i>arial@gmail.com</li>
										</ul>
									</div>
